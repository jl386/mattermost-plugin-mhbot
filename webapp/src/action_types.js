...
export const GET_LAST_RATING = pluginId + "_get_last_rating";
export const OPEN_ROOT_MODAL = pluginId + "_open_root_modal";
export const OPEN_TREND_MODAL = pluginId + "_open_trend_modal";
export const CLOSE_ROOT_MODAL = pluginId + "_close_root_modal";
export const CLOSE_TREND_MODAL = pluginId + "_close_trend_modal";
...
export const TREND_VIEW = pluginId + "_trend_view";
